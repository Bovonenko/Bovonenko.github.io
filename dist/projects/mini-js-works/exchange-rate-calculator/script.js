window.addEventListener('DOMContentLoaded', () => {
    ...
    function getDataFromJSON() {
        request('https://v6.exchangerate-api.com/v6/c25c03d649342c8aaf1d0230/codes')
            .then(data => {
                renderCurr(data.supported_codes, currencyItem1, 'USD');
                renderCurr(data.supported_codes, currencyItem2, 'EUR');            
            })
            .then(calculate)
